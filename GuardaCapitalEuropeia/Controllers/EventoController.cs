...
namespace GuardaCapitalEuropeia.Controllers
{
    public class EventoController : Controller
    {
        ...
        public EventoController(RestaurantesContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventoId,Nome,Localizacao,Descricao,Entrada")] Evento evento)
        {
